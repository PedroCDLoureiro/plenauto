...
?>
<section id="nossos-enderecos" class="bg-primary">
    <div class="container d-flex flex-column align-items-center">
        <h2 class="text-center text-white mb-5">Nossos Endereços</h2>
                ...
                ?>
                    <div class="item">
                        <div class="d-flex flex-column align-items-center text-center content">
                            ...
                            <h4 class="text-white fw-bold mb-0"><?= $titulo ?></h4>
                            <div class="d-flex flex-column gap-2 w-100 infos-endereco">
                                <div class="d-flex align-items-center gap-2 endereco">
                                    ...
                                    <p class="text-white mb-0"><?= $endereco; ?></p>
                                </div>
                                <div class="d-flex align-items-center gap-2 telefone">
                                    ...
                                    <p class="text-white mb-0"><?= $telefone; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
